...
class MyFrame(wx.Frame):
    def __init__(self, parent, id):
        ...
        layout_username.Add(self.label_username, proportion=0,
                            flag=wx.ALL | wx.EXPAND, border=5)
        layout_username.Add(self.text_username, proportion=1,
                            flag=wx.ALL | wx.EXPAND, border=5)
        # 密码及输入组件横向排列
        layout_password = wx.BoxSizer(wx.HORIZONTAL)
        layout_password.Add(self.label_password, proportion=0,
                            flag=wx.ALL | wx.EXPAND, border=5)
        layout_password.Add(self.text_password, proportion=1,
                            flag=wx.ALL | wx.EXPAND, border=5)
        # 确定和取消按钮横向排列
        layout_button = wx.BoxSizer(wx.HORIZONTAL)
        layout_button.Add(self.bt_ok, proportion=0,
                          flag=wx.ALIGN_CENTER, border=5)
        layout_button.Add(self.bt_cancel, proportion=0,
                          flag=wx.ALIGN_CENTER, border=5)

        # 用户，密码，按钮容器纵向排列
        layout_all = wx.BoxSizer(wx.VERTICAL)
        layout_all.Add(layout_username, proportion=0,
                       flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=5)
        layout_all.Add(layout_password, proportion=0,
                       flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=5)
        layout_all.Add(layout_button, proportion=0,
